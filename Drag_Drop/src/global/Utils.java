...
//	        long elapsedTime_mil = (etime - startTime) % 1000;
	        long hours = elapsedTime_sec/3600;
	        long remain_sec = elapsedTime_sec%3600;
	        long mins = remain_sec/60;
	        long secs = remain_sec%60;
	        
	        System.out.print("  ===>Elapsed Time (HH:MM:SS): " + hours + " : " + mins + " : " + secs);
	        System.out.println("");
	        ...
	        try {
				...
				Prop.bw.newLine();
				Prop.bw.append(" [INFO] " + "  ===>Elapsed Time: " + hours + " : " + mins + " : " + secs);
				Prop.bw.newLine();
				Prop.bw.flush();
			} catch (IOException e) {
				//Utils.error("Failed to write log.");
